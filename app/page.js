        ...
        <div className="container mx-auto px-2 sm:px-4 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 mt-2 sm:mt-0">
              ...
              {user ? (
                <>
                  <div className="flex items-center space-x-1 sm:space-x-2 bg-accent/50 dark:bg-accent/30 rounded-lg px-3 py-1.5 backdrop-blur-sm">
                    ...
                    <Badge 
                      ...
                      className="text-xs bg-gradient-to-r from-primary to-purple-500 text-white border-0"
                    >
                      {user.role}
                    </Badge>
                  </div>
